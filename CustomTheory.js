...
var init = () => {
    ...
    theory.createCoinsUpgrade(3, currency, 1e200);
    ...
    achievement1 = theory.createAchievement(0, "睷", "huh", () => c1.level > 1);
    achievement2 = theory.createSecretAchievement(1, "睷", "huh", "Maybe you should buy two levels of c2?", () => c2.level > 1);
...
var getCoins = (level) => BigNumber.Two.pow(level)
